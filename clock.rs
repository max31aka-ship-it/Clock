// clock.rs - Аналоговые часы на Rust (веб-сервер)
use actix_web::{web, App, HttpResponse, HttpServer, Result};

async fn index() -> HttpResponse {
    let html = r#"<!DOCTYPE html>
<html><head><meta charset="UTF-8"><title>🕐 ClockForge - Rust</title>
<style>body{display:flex;justify-content:center;align-items:center;min-height:100vh;background:#2c3e50;margin:0;font-family:system-ui;}
